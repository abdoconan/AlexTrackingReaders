...
namespace AlexPortTracking.Migrations
{
    ...
    [Migration("20240415070428_updated_car")]
    partial class updated_car
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlexPortTracking.Models.Car", b =>
                {
                    ...
                    b.Property<float>("MaxLoadedWeight")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("AlexPortTracking.Models.CarClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlexPortTracking.Models.CarType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlexPortTracking.Models.Governorate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlexPortTracking.Models.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("LogTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 15, 9, 4, 23, 583, DateTimeKind.Local).AddTicks(4743));
            ...
            modelBuilder.Entity("AlexPortTracking.Models.TransactionLog", b =>
                {
                    ...
                    b.Property<DateTime>("LogTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 15, 9, 4, 23, 584, DateTimeKind.Local).AddTicks(3828));
            ...
            modelBuilder.Entity("AlexPortTracking.Models.Car", b =>
                {
                    b.HasOne("AlexPortTracking.Models.CarClass", "CarClass")
                        .WithMany("Cars")
                        .HasForeignKey("CarClassId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("AlexPortTracking.Models.CarType", "CarType")
                        .WithMany("Cars")
                        .HasForeignKey("CarTypeId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("AlexPortTracking.Models.Governorate", "Governorate")
                        .WithMany("Cars")
