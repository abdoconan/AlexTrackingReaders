...
namespace AlexPortTracking.Migrations
{
    ...
    [Migration("20240314080713_updatedColumnLengthInTag")]
    partial class updatedColumnLengthInTag
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AlexPortTracking.Models.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("LogTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 14, 10, 7, 11, 446, DateTimeKind.Local).AddTicks(787));
            ...
            modelBuilder.Entity("AlexPortTracking.Models.TransactionLog", b =>
                {
                    ...
                    b.Property<DateTime>("LogTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 14, 10, 7, 11, 446, DateTimeKind.Local).AddTicks(4910));
